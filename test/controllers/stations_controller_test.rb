...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { address: @station.address, code: @station.code, name: @station.name, no: @station.no, region: @station.region }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { address: @station.address, code: @station.code, name: @station.name, no: @station.no, region: @station.region }
    assert_redirected_to station_path(assigns(:station))
  end
