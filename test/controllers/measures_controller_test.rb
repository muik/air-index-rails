...
class MeasuresControllerTest < ActionController::TestCase
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post :create, measure: { grade: @measure.grade, index: @measure.index, station: @measure.station, time: @measure.time }
    end
  ...
  test "should update measure" do
    patch :update, id: @measure, measure: { grade: @measure.grade, index: @measure.index, station: @measure.station, time: @measure.time }
    assert_redirected_to measure_path(assigns(:measure))
  end
